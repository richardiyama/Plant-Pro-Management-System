@extends('layouts.app', ['activePage' => 'allpdsdrbyfleet', 'titlePage' => __('Calculate Fuel Consumption')])
@section('content')
<div class="content">
    <div class="container">
                        ...
                        <div class="table-responsive">
                            <table id="example"  style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach($allpdsdrbyfleet as $fuel)
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                           $first = DB::table('pdsdrs')->join('pdsdr_date_reports','pdsdrs.created_at','=','pdsdr_date_reports.created_at')->where('pdsdr_date_reports.date_entry','=', $start)->get();
                                          //dd($first);
                                          foreach($first as $result)
                                          {
                                              if($result->fleet_no == $fuel->fleet_no)
                                              {
                                                  //dd($result->hour_meter_reading);
                                                 echo $result->hour_meter_reading;
                                              }
                                          }
                                          
                                          //$result = DB::table('pdsdrs')->where('fleet_no',$first->fleet_no)->distinct()->first();
                                          //dd($result->hour_meter_reading);
                                           //echo $result->hour_meter_reading;
                                         ?>
